...
$input_arrays = array('array_fields_hidden', 'array_fields_text', 'array_fields_number', 'array_fields_select', 'array_fields_img', 'array_fields_textarea', 'array_fields_date', 'array_fields_time', 'array_fields_price', 'array_galeries');
