...
function selectImg(str) {
	var path = "http://localhost/app/webroot/img/cursos/";
...
<?php  $path = "http://localhost/app/webroot/img/cursos/"; ?>
    ...
    <?php
		...
		foreach($conn->query("SELECT * FROM cursos_galeria WHERE id_cursos ='".$id."'") as $row_gal) {
