...
function selectImg(str) {
	var path = 'http://localhost/ctesop/app/webroot/img/noticias/';
...
<!-- <link rel="stylesheet" type="text/css" href="//CSS_DIRmobile.css" /> -->

<?php  $path = 'http://localhost/ctesop/app/webroot/img/noticias/'; ?>
    ...
    <?php
		...
		foreach($conn->query("SELECT * FROM noticias_galeria WHERE id_noticias ='".$id."'") as $row_gal) {
